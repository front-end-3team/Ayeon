...
function newArr(arr, num1) {
    const newMapArr = arr.map((item) => item + 10);

    if (newMapArr.find((item) => item === num1)) {
        let newFilterArr = newMapArr.filter((item) => item != num1);
        return console.log(newFilterArr);
    } else {
