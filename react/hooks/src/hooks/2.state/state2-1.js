...
import Comment from '../../components/2.state/comment-1';
...
function State2() {
    ...
    */
    ...
    const [comment, setComment] = useState({ nickname: '', content: '' });
        ...
        <S.Wrapper>
            ...
            <div>
                ...
                <input
                    ...
                    onChange={onNewComment}
                />
                <button onClick={onAddCommentList}>댓글 작성</button>
            </div>
            <S.CommentList>
                {/* list */}
                {/* 예시 데이터 */}
                <Comment onRemoveComment={onRemoveComment} post={post.Comments} />
            </S.CommentList>
        </S.Wrapper>
    );
}
